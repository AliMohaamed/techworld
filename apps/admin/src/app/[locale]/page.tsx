    ...
    return (
      <main className="flex min-h-[60vh] flex-col items-center justify-center space-y-6 text-center animate-in fade-in duration-700 bg-background">
        ...
        <div className="space-y-2">
          ...
          <p className="h-14 px-10 rounded-2xl bg-[#ffc105] text-black hover:bg-foreground hover:text-background transition-all font-bold text-sm">
    ...
    <main className="space-y-8 animate-in fade-in duration-500 pb-12 bg-background transition-colors">
      ...
      <section className="flex flex-col md:flex-row md:items-center justify-between gap-6 rounded-[32px] border border-border bg-card px-8 py-10   relative overflow-hidden group">
        ...
        <div className="relative z-10">
          ...
          <h1 className="mt-4 text-4xl font-bold text-foreground leading-tight md:text-5xl">
            {t("title")}
          </h1>
        ...
        >
          <div className="rounded-[32px] border border-border bg-card p-10   transition-all relative overflow-hidden group">
            ...
            <div className="mb-10 flex items-center justify-between relative z-10">
              ...
              <div className="flex items-center gap-3 rounded-2xl border p-5 text-xs font-bold transition-all cursor-pointer shadow-sm group">
      ...
      {metrics?.metadata?.isFinancialsVisible && (
        <section className="grid gap-6 grid-cols-1 md:grid-cols-2">
          <div className="group rounded-[32px] border border-border bg-card p-10 border-l-8 border-l-[#ffc105]   transition-all hover:scale-[1.01]">
            <h3 className="text-xs font-bold text-[#ffc105]">
              {t("health.snapshot")}
            </h3>
            <div className="mt-10 flex flex-col md:flex-row items-start md:items-end justify-between gap-8">
              <div>
                ...
                <h4 className="mt-3 text-4xl font-bold text-foreground">
          ...
          <div className="rounded-[32px] border border-border bg-accent/10 p-10 flex items-center justify-center relative overflow-hidden group  ">
            ...
            <p className="rounded-2xl h-14 px-8 bg-foreground text-background hover:bg-[#ffc105] hover:text-black transition-all font-bold text-xs">
              {t("health.compliance")}
            </p>
          </div>
        </section>
