...
export default function StorefrontHomePage() {
  ...
  return (
    <div className="min-h-screen bg-black overflow-x-hidden">
      ...
      <Suspense fallback={<div className="container mx-auto py-24 px-8"><Skeleton className="h-[400px] w-full rounded-[32px]" /></div>}>
        <CategorySection />
      </Suspense>
      
      <Suspense fallback={<div className="container mx-auto py-24 px-8"><Skeleton className="h-[600px] w-full rounded-[32px]" /></div>}>
        {products && (
